<?php
require_once('../require/about_require.php');
?>
...
<html>
    ...
    <div>
        ...
        <div class="infa-1"></div>
        <div class="main-container">
       
          <form action="about.php" method="post" style="width: 100%; height:100%;">
            <div class="cont1">
            <h2> График посещаемости баз отдыха в Омутнинске</h2>

                <?php echo '<img src="' . $filename . '">';?>
            
                <h3><?php if (!empty($counts)) {
                echo "Пока среди всех баз отдыха в Омутнинске лидирует $mostPopularHotel, его посетило уже $mostPeople человек. Посетите и Вы!";} 
              ?></h3>

            <p style="text-align:center; width:90% ">Зачем этот график? Визуализация помогает выявить наиболее популярные и менее востребованные базы отдыха среди туристов, 
              что может быть полезно для анализа спроса и планирования мероприятий по привлечению гостей. 
              Например, если видно, что одна из баз имеет значительно большее количество посетителей, это может 
              свидетельствовать о её лучших условиях проживания, развлечениях или расположении. С другой стороны,
              базы с меньшим числом посетителей могут нуждаться в улучшении инфраструктуры или маркетинговых стратегий.</p>
